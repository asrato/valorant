...
interface DesktopBuddyImageProps {
  image: string;
  label: string;
}

export default function DesktopBuddyImage(props: DesktopBuddyImageProps) {
  ...
  return (
    <div className="w-full flex flex-col gap-1.5">
      <div
        className={`z-10 flex items-center justify-center p-4 w-full relative border-2 bg-valorant-black border-white bg-gradient-to-t from-black/50 via-transparent to-transparent ${beforeClasses} ${afterClasses}`}
      >
        <Image src={image} />
      </div>
